                ...
                <div class="main-form">
                    ...
                    <div class="mandatory-data">
                        ...
                        <div class="form-field">
                            ...
                            <input id="firstname" class="firstname" name="firstname" value=""
                        ...
                        <div class="form-field">
                            ...
                            <input id="productinfo" class="productinfo" name="productinfo" value=""
                                placeholder="Apple Laptop">
                        </div>

                        <div class="form-field">
                            <label for="surl">Success URL<sup>*</sup></label>
                            <input id="surl" class="surl" name="surl" value="http://localhost:8000/response"
                                placeholder="http://localhost:8000/response.php">
                        </div>

                        <div class="form-field">
                            <label for="furl">Failure URL<sup>*</sup></label>
                            <input id="furl" class="furl" name="furl" value="http://localhost:8000/response"
                                placeholder="http://localhost:8000/response">
                        </div>
